...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Caloteiros is a financial control app for couples with separate accounts." },
      { property: "og:description", content: "Caloteiros is a financial control app for couples with separate accounts." },
      { name: "twitter:description", content: "Caloteiros is a financial control app for couples with separate accounts." },
